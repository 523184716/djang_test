$(document).ready(function() {
    ...
    get_deploys(function (data) {
        ...
        $.each(data["deploys"], function(i, n) {
            ...
            var action_td = $("<td></td>");
            action_td.append($("<a href=\"javascript:void(0)\" deploy_id="+n["id"].toString()+" class=\"info\">详细</a>"));
            if (n["status"] == 1){
                action_td.append($("<span class=\"cut-line\" style=\"margin-right: 5px;margin-left: 5px;\">¦</span>"));
                action_td.append($("<a href=\"javascript:void(0)\" deploy_id="+n["id"].toString()+" class=\"rollback\">回滚</a>"));
            } else if(n["status"] == 0){
                action_td.append($("<span class=\"cut-line\" style=\"margin-right: 5px;margin-left: 5px;\">¦</span>"));
                action_td.append($("<a href=\"javascript:void(0)\" deploy_id="+n["id"].toString()+" class=\"redeploy\">重新回滚</a>"));
            }
            tr.append(action_td);
